  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Business with Invoice-App: Streamline Billing, Enhance Client Experience, and Simplify Financial Management All in One Platform"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Business with Invoice-App: Streamline Billing, Enhance Client Experience, and Simplify
              Financial Management All in One Platform
            </Text>
